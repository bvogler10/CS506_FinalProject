        ...
        <section className="relative overflow-hidden py-20 md:py-32">
          ...
          <div className="container relative z-10 mx-auto px-4 text-center">
            ...
            <p className="mx-auto mb-8 max-w-2xl text-xl">
              New Game Plus uses our speciality trained models to analyze your
              Steam library and recommend games you'll love. No more endless
              scrolling through the store.
            </p>
            ...
            <div className="grid gap-8 md:grid-cols-3">
              <div className="flex flex-col items-center text-center p-6 rounded-lg bg-gray-800">
                ...
                <p className="text-gray-400">
                  Provide your Steam ID so we can analyze your gaming
              ...
              <div className="flex flex-col items-center text-center p-6 rounded-lg bg-gray-800">
                ...
                <p className="text-gray-400">
                  Our models analyze your playtime, game genres, and more to
              ...
              <div className="flex flex-col items-center text-center p-6 rounded-lg bg-gray-800">
                ...
                <p className="text-gray-400">
                  Receive personalized game recommendations that match your
                  unique gaming style.
                </p>
              </div>
            </div>
            ...
            <div className="grid gap-12 md:grid-cols-2 items-center">
              <div>
                ...
                <p className="mb-6 text-gray-400">
                  New Game Plus was created by a team of passionate gamers who
                  were tired of the Steam store algorithm recommending the same
                  games over and over.
                </p>
                <p className="mb-6 text-gray-400">
                  Our recommendation engine goes beyond the obvious choices to
                  find hidden gems that match your unique gaming preferences.
                </p>
